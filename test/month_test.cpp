...
TEST_F(MonthTest, DataHandling) {
    ...
    // Because it has 18 days, it ends on the 20th, on 'D' day.
    ...
    Properties davidianCalendar{
        ...
        std::vector<size_t>{20, 22, 18, 22, 20, 22},
    ...
    // System under Test
    MonthElement testElement("Dave", size_t(3), size_t(20), size_t(2), size_t(11),
                             davidianCalendar);
    ...
    DataStorage expectedDataVector{
        ...
        {CellType::Label, "16"},    {CellType::Workday, ""},    {CellType::Workday, ""},
        {CellType::Weekend1, ""},   {CellType::Weekend2, ""},   {CellType::Label, "17"},
